    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        @if (auth()->user()->role === 'Admin')
            ...
            <li class="nav-item  {{ Request::is('admin/guru*') ? 'active' : '' }} ">
                ...
                <div id="collapseDataGuru" class="collapse" aria-labelledby="headingTwo"
            ...
            <li class="nav-item  {{ Request::is('admin/siswa*') ? 'active' : '' }}">
                ...
                <div id="collapseDataSiswa" class="collapse" aria-labelledby="headingTwo"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
            ...
            <li class="nav-item  {{ Request::is('admin/walikelas*') ? 'active' : '' }}">
                ...
                <div id="collapseDataWaliKelas" class="collapse" aria-labelledby="headingTwo"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Data Siswa:</h6>
            ...
            <li class="nav-item  {{ Request::is('admin/matapelajaran*') ? 'active' : '' }}">
                ...
                <div id="collapseDataMapel" class="collapse" aria-labelledby="headingTwo"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('index_atur_mata_pelajaran') }}">Atur Mata
                            Pelajaran</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item  {{ Request::is('admin/nilaisiswa*') ? 'active' : '' }}">
                ...
                <div id="collapseNilaiSiswa" class="collapse" aria-labelledby="headingTwo"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
            ...
            <li class="nav-item  {{ Request::is('admin/mapelguru*') ? 'active' : '' }}">
                ...
                <div id="collapseMapelGuru" class="collapse" aria-labelledby="headingTwo"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
            ...
            <li class="nav-item  {{ Request::is('admin/penempatan*') ? 'active' : '' }}">
                <a class="nav-link collapsed" href="#" data-toggle="collapse"
                    data-target="#collapsePenempatanSiswa" aria-expanded="true"
                    aria-controls="collapsePenempatanSiswa">
                    <i class="fas fa-fw fa-cog"></i>
                    <span>Penempatan Siswa</span>
                </a>
                <div id="collapsePenempatanSiswa" class="collapse" aria-labelledby="headingTwo"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Penempatan Siswa:</h6>
                        <a class="collapse-item" href="{{ route('index_data_penempatan_siswa') }}">Lihat Penempatan
                            Siswa</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item  {{ Request::is('admin/tahunajaran*') ? 'active' : '' }}">
                <a class="nav-link collapsed" href="#" data-toggle="collapse"
                    data-target="#collapseTahunAjaran" aria-expanded="true" aria-controls="collapseTahunAjaran">
                    <i class="fas fa-fw fa-cog"></i>
                    <span>Tahun Ajaran</span>
                </a>
                <div id="collapseTahunAjaran" class="collapse" aria-labelledby="headingTwo"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Tahun Ajaran:</h6>
                        <a class="collapse-item" href="{{ route('index_data_tahun_ajaran') }}">Lihat Tahun Ajaran</a>
                        <a class="collapse-item" href="{{ route('create_data_tahun_ajaran') }}">Tambah Tahun
                            Ajaran</a>
            ...
            <li class="nav-item  {{ Request::is('admin/kelas*') ? 'active' : '' }}">
                ...
                <div id="collapseKelas" class="collapse" aria-labelledby="headingTwo"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
        ...
        @elseif (auth()->user()->role == 'Guru')
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('index_data_nilai_siswa') }}">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Nilai Siswa</span>
                </a>
            </li>
