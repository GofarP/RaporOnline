...
@extends('partials.sidebar.sidebar')
    ...
    <div class="card shadow mb-4 w-100" >
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary"> Edit Kredensial Siswa</h6>
        </div>

        <div class="card-body">

            <form method="POST" action="{{route('update_kredensial_siswa',$user->id_users)}}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <input type="submit" class="form-control btn btn-success mt-3" value="Update Kredensial Siswa" style="border-radius:100px">
                </div>
