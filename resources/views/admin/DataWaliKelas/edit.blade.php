...
@extends('partials.sidebar.sidebar')
    ...
    <div class="card shadow mb-4 w-100" >
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{route('update_data_wali_kelas',$data_wali_kelas->id_wali_kelas)}}">
                @csrf
                @method('PUT')

                <div class="mb-3">
                    <span>NIP: {{$data_wali_kelas->nip}} </span>
                    <input type="hidden" value="{{$data_wali_kelas->nip}}" name="nip"/>
                </div>

                <div class="mb-3">
                    <span>Nama Guru: {{$data_wali_kelas->nama}} </span>
                </div>
                ...
                <div class="mb-3">
                    <input type="submit" class="form-control btn btn-success mt-3" value="Update Wali Kelas" style="border-radius:100px">
                </div>
