...
@extends('partials.sidebar.sidebar')
    ...
    <div class="card shadow mb-4 w-100" >
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{route('store_kredensial_guru')}}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-3">
                    <input type="submit" class="form-control btn btn-success mt-3" value="Tambah Kredensial Guru" style="border-radius:100px">
                </div>
