        ...
        <div class="card-body">
            ...
            @endif
                <div class="mb-3">
                            ...
                            <select class="form-control @error('id_tahun_ajaran') is-invalid @enderror"
                             name="id_tahun_ajaran" id="id_tahun_ajaran">
                ...
                <div class="mb-3">
                    <input type="submit" class="form-control btn btn-success mt-3" value="Tetapkan Tahun Ajaran" style="border-radius:100px">
                </div>
