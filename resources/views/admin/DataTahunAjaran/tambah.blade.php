...
@extends('partials.sidebar.sidebar')
    ...
    <div class="card shadow mb-4 w-100" >
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary"> Tambah Data Tahun Ajaran</h6>
        </div>

        <div class="card-body">

            <form method="POST" action="{{route('store_data_tahun_ajaran')}}">
                @csrf
                        ...
                        <div class="col-4">
                          ...
                          <div class="input-group date" id="datepicker_tahun_awal">
                            ...
                            <input type="text" name="tahun_awal" id="tahun_awal" class="form-control @error('tahun_awal') is-invalid @enderror"
                             value="{{old('tahun_awal')}}" placeholder="Tanggal-Bulan-Tahun" readOnly="true">
                        ...
                        <div class="col-4 mb-4">
                          ...
                          <div class="input-group date" id="datepickertahun_akhir">
                            ...
                            <input type="text" name="tahun_akhir" id="tahun_akhir" class="form-control @error('tahun_akhir') is-invalid @enderror"
                             value="{{old('tahun_akhir')}}" placeholder="Tanggal-Bulan-Tahun" readOnly="true">
                ...
                <div class="mb-3">
                    <input type="submit" class="form-control btn btn-success mt-3" value="Tambah Tahun Ajaran" style="border-radius:100px">
                </div>
